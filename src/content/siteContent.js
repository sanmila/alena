...
export const siteContent = {
  ...
  ru: {
    meta: {
      ...
      pageTitle: 'Алёна Готто | Гипнотерапевт, Работа с подсознанием онлайн',
      description:
        'Алёна Готто — гипнотерапевт и специалист по работе с подсознанием. Помогу избавиться от тревоги, выгорания, проблем со сном и ограничивающих блоков. Запишитесь на бесплатную онлайн-консультацию.',
      ogTitle: 'Алёна Готто | Гипнотерапевт, Работа с подсознанием онлайн',
      ogDescription:
        'Алёна Готто — гипнотерапевт и специалист по работе с подсознанием. Помогу избавиться от тревоги, выгорания, проблем со сном и ограничивающих блоков. Запишитесь на бесплатную онлайн-консультацию.',
      ogImage: '/images/hero.webp',
    },
